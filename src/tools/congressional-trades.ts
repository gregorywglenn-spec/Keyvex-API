...
export const definition: Tool = {
  ...
  description: [
    ...
    "",
    "Heads-up: ticker can be '--' on records covering municipal bonds,",
    "structured notes, and other non-equity instruments that have no",
    "equity ticker (especially common in Senate filings — McCormick,",
    "Collins, Mullin file lots of these). The asset_name field carries",
    "the full instrument identifier (issuer + coupon + maturity) for",
    "those rows. Pass a ticker filter and you'll naturally exclude them.",
    "",
    "Cross-tool composition: each record carries a `bioguide_id`. Pass",
    "that to get_member_profile for party/state/committee context, or to",
    "get_historical_member if the trade is from a member who has since",
    "left office.",
  ].join(" "),
  inputSchema: {
    type: "object",
