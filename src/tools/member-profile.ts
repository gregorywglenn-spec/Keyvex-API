...
export const definition: Tool = {
  ...
  description: [
    ...
    "",
    "If a bioguide_id lookup returns 0 hits, the member may have left",
    "office and only exist in legislators_historical — fall back to",
    "get_historical_member for retired members, deceased members,",
    "members who resigned mid-term (e.g., Markwayne Mullin moved to",
    "historical when Alan Armstrong replaced him in 2026).",
    "",
